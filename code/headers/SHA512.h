...
struct HashResult {
	...
	unsigned long long hashBinary[HASH_LEN];  //HASH_LEN
};
...
public:
	//std::string hash(const std::string input);	//removed for CRYPTOR project
	void hash512(const std::string input, HashResult *hr);
